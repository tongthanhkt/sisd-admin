...
export const PRODUCT_CATEGORIES = {
  ...
  CT: 'CT',
  SPC: 'SPC',
  JOINT_SEALANT_D8: 'JOINT_SEALANT_D8'
};
...
export const PRODUCT_LABELS = {
  ...
  [PRODUCT_CATEGORIES.JOINT_SEALANT_D8]: 'Keo xử lý mối nối D8'
};
...
export const productCategories = [
  ...
  { id: PRODUCT_CATEGORIES.JOINT_SEALANT_D8, name: PRODUCT_LABELS[PRODUCT_CATEGORIES.JOINT_SEALANT_D8] }
];
